...
- 실행 이력: **2026-08-17 (월)** — baseline 최초 실행. **2026-08-18 (화)** — 신규 9건 + 기존 2건 업데이트. **2026-08-19 (수)** — 신규 5건(DTW BHS장애, Journey Robotics, IAD 탑승교 상호충돌, 산타바바라 탑승교 붕괴, PWS 식수 안전성 연구) + 기존 1건 업데이트(버밍엄 BHX 복구 08-12). 밀라노 말펜사 수하물카트 화재는 GSE(견인카트)로 스코프 제외.
